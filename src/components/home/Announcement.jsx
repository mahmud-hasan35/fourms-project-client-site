...
function Announcement() {
  ...
  if (isError) {
    return (
      <div className="text-center py-20 bg-red-50 rounded-lg max-w-2xl mx-auto shadow-md">
        <p className="text-red-600 font-semibold">
          Error fetching announcements: {error.message}
        </p>
        <button
          className="mt-4 px-4 py-2 bg-red-100 text-red-700 rounded-md hover:bg-red-200 transition duration-200"
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="text-center mb-14">
        <div className="inline-flex items-center justify-center bg-yellow-100 w-16 h-16 rounded-full mb-4 shadow-inner">
      ...
      <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        {announcements.map((a) => (
          <div
            key={a._id}
            className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-shadow duration-300 border border-gray-100 overflow-hidden flex flex-col"
          >
